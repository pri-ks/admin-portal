        ...
        <div className="modal fade" ref={modalRef}>
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">Add Promotion Details</div>
                    <form name="AddPromotionForm" onSubmit={onAdd}>
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" name="couponCode" className="form-control" required />
                            </div>
                            <div className="mb-3">
